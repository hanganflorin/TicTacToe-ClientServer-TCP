...
namespace TicTacToe_Client
{
    public partial class Form1 : Form
    {
        ...
        private void Handler_Click(int i, int j)
        {
            ...
            {
                Poza(i, j).Image = imageList1.Images[2];
                a[i, j] = 2;
                if ( Castigator() )
                {
        ...
        private void Connection()
        {
            while ( true )
            {
                try
                {
                    ...
                    if (!client.ConnectAsync("31.5.88.5", 1260).Wait(4000))
                        continue;
            ...
            while ( true )
            {
                try
                {
                    ...
                    if ( type == 1 )
                    {
                        ...
                        Poza(nr / 10, nr % 10).Image = imageList1.Images[1];
                        a[nr / 10, nr % 10] = 1;
                        if (Castigator())
                        {
                            this.Invoke(new Action(() =>
                ...
                {
                    MessageBox.Show(@"Meh, o eroare ¯\_(ツ)_/¯ ");
                    Application.Exit();
                }
